<template>
    <div class="w-[1200px] mx-auto mt-10 bg-linear-to-br from-blue-50 to-indigo-50 rounde-[20px] p-20 shadow-lg">
        <div class="h-20">
        ...
        <div class="flex items-center gap-2 mb-10">
            <el-input @keyup.enter="searchWord" class="mr-10" placeholder="请输入单词" v-model="query.word"></el-input>
...
import { getWordBookList } from "@/api/word-book";
import { Reading, VideoPlay } from "@element-plus/icons-vue";
import type { WordList, WordQuery } from "@en/common/word/index";
